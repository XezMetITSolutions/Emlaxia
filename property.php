...
if ($slug) {
    $stmt = $pdo->prepare("SELECT * FROM listings WHERE slug = :slug");
...
if (!$listing) {
    // 404 header ensures SEO doesn't index error page
...
<head>
    ...
    <?php if ($listing['meta_description']): ?>
    <meta name="description" content="<?php echo htmlspecialchars($listing['meta_description']); ?>">
    <?php endif; ?>
...
<body>
    ...
    <main>
        <div class="container">
            <a href="ilanlar" class="btn btn-secondary" style="margin-bottom: 20px;" data-i18n="back">← <?php echo t('back'); ?></a>
            ...
            <div class="property-gallery-section">
                ...
                <?php else: ?>
                    <div class="property-image-main">
                        <img src="/uploads/<?php echo htmlspecialchars($images[0]); ?>" alt="<?php echo htmlspecialchars($listing['title_' . $lang]); ?>" class="property-main-image" id="mainImage">
                    ...
                    <?php if (count($images) > 1): ?>
                        <div class="property-thumbnails">
                            <?php foreach ($images as $index => $img): ?>
                                <div class="thumbnail-wrapper <?php echo $index === 0 ? 'active' : ''; ?>" onclick="changeMainImage('/uploads/<?php echo htmlspecialchars($img); ?>', <?php echo $index; ?>, <?php echo count($images); ?>)">
                                    <img src="/uploads/<?php echo htmlspecialchars($img); ?>" alt="Thumbnail <?php echo $index + 1; ?>" class="thumbnail-img">
                                </div>
                            <?php endforeach; ?>
                        </div>
                    <?php endif; ?>
            ...
            <?php if (!empty($listing['video'])): ?>
                <div class="property-video-section" style="margin-top: 2rem;">
                    ...
                    <div class="video-container" style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: var(--radius-2xl); box-shadow: var(--shadow-xl);">
                        <video controls style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; border-radius: var(--radius-2xl);">
            ...
            <div class="property-content-section">
                ...
                <div class="property-header-card">
                    <div class="property-header-top">
                        ...
                        <?php if (!empty($listing['listing_type'])): ?>
                            <span class="property-type-badge" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);">
                                <?php echo t($listing['listing_type']); ?>
                            </span>
                        <?php endif; ?>
                        <?php if (!empty($listing['ilan_sahibi_turu'])): ?>
                            <span class="owner-type-badge <?php echo $listing['ilan_sahibi_turu'] == 'Emlakçı' ? 'realtor' : 'owner'; ?>">
                                <?php echo $listing['ilan_sahibi_turu'] == 'Emlakçı' 
                                    ? ($lang == 'tr' ? '🏢 Emlakçıdan' : '🏢 From Realtor') 
                                    : ($lang == 'tr' ? '👤 Sahibinden' : '👤 From Owner'); ?>
                            </span>
                        <?php endif; ?>
                        <h1><?php echo htmlspecialchars($listing['title_' . $lang]); ?></h1>
                    </div>
                    <div class="property-price-card">
                        <span class="price-label" data-i18n="price"><?php echo $lang == 'tr' ? 'Fiyat' : 'Price'; ?></span>
                        <span class="price-value"><?php echo number_format($listing['price'], 0, ',', '.'); ?> <?php echo t('currency'); ?></span>
                        <?php if (!empty($listing['ilan_sahibi_turu']) && $listing['ilan_sahibi_turu'] == 'Emlakçı' && !empty($listing['komisyon_yuzdesi'])): ?>
                ...
                <div class="property-basic-card">
                    <h2 class="card-title" data-i18n="basic_info"><?php echo $lang == 'tr' ? 'Temel Bilgiler' : 'Basic Information'; ?></h2>
                        ...
                        <?php if ($listing['city']): ?>
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <span class="info-value"><?php echo htmlspecialchars($listing['city']); ?><?php echo $listing['district'] ? ', ' . htmlspecialchars($listing['district']) : ''; ?><?php echo $listing['mahalle'] ? ', ' . htmlspecialchars($listing['mahalle']) : ''; ?></span>
                                </div>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="details-grid">
                                ...
                                <?php if ($listing['bina_yasi']): ?>
                                    <div class="detail-item">
                                        ...
                                        <span><?php echo $listing['bina_yasi']; ?> <?php echo $lang == 'tr' ? 'Yıl' : 'Years'; ?></span>
                                    </div>
                                <?php endif; ?>
                ...
                <?php if ($listing['notes']): ?>
                    <div class="property-description-card">
                        <h2 class="card-title" data-i18n="notes"><?php echo $lang == 'tr' ? 'Notlar ve Ek Bilgiler' : 'Notes and Additional Information'; ?></h2>
                        <div class="description-content">
                ...
                <div class="offer-form-card">
                    ...
                    <form action="offer.php" method="POST" class="offer-form-modern">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <label data-i18n-form-label="offer_amount"><?php echo t('offer_amount'); ?> (<?php echo t('currency'); ?>) *</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="message" rows="4" data-i18n-placeholder="message" placeholder="<?php echo $lang == 'tr' ? 'Mesajınızı buraya yazabilirsiniz...' : 'You can write your message here...'; ?>"></textarea>
                        </div>
