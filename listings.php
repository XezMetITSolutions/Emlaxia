...
<head>
    ...
    <title><?php echo t('listings'); ?> - Emlaxia</title>
                ...
                <?php else: ?>
                    <?php foreach ($listings as $listing): ?>
                        <div class="listing-card">
                            <?php 
                            $url = !empty($listing['slug']) ? 'ilan/' . $listing['slug'] : 'property.php?id=' . $listing['id'];
                            ?>
                            ...
                            <div class="listing-info">
                                ...
                                <h3><a href="<?php echo $url; ?>" class="listing-title-link"><?php echo htmlspecialchars($listing['title_' . $lang]); ?></a></h3>
